  ...
  try {
    ...
    reservas.forEach(reserva => {
      ...
      if (status === 'confirmada') {
        ...
        // Botão para reserva pendente, pode permitir ação (ex: confirmar)                              // JULIANA EM 07/06: mesa_reserva
        ...
        // Botão para reserva cancelada, possível ação de visualização ou outra                        // JULIANA EM 07/06: mesa_reserva
