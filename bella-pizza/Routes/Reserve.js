...
//Amós 07/06/2025
const {initDb, getReservas, updateStatusReserva} = require('../Controllers/statuscontroler');
...
//JULIANA EM 07/06:
router.put('/:id/cancelar', cancelarReserva); //Redireciona para o Controller de cancelar Reserva

//Amós 07/06:
router.patch('/status', initDb, getReservas, updateStatusReserva);
